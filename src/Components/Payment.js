    ...
    return(
        <div className='f-col py-3 px-4'>
            ...
            <div className='f-col mt-3 w-100'>
                <button className='btn Active-btn m-2 f-row justify-content-between py-3 px-3 fs-5' onClick={handleCreditcardPayment}>
                    <div className='fs-5'><i className="bi bi-credit-card-2-front"></i> Credit Card </div>
                    {offer.newPrice}
                </button>
                <button className='btn Active-btn m-2 f-row justify-content-between  py-3 px-3 fs-5' onClick={handleFawryPayment}>
                    <img src='../images/fawryicon.jpg'></img>
                    {offer.newPrice}
                </button>
                <button className='btn Active-btn m-2 f-row justify-content-between  py-3 px-3 fs-5' onClick={handleVodafoneCashPayment}>
            ...
            <button className='btn my-btn-outline py-3' onClick={()=>{}}>Cash On Spot</button>
        </div>
    );
}
